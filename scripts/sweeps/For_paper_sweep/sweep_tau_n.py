...
from scripts.sweeps.nondimensional.ODEs.tau_n import *
...
if __name__ == "__main__":
    ...
    for i, A in enumerate(tau_n_vals):
        print("tau_n: ", A)
        ...
        wavelength, frequency = Hilbert_Transform(kappa_reduced, N, N_controls, t_eval)
    ...
    plt.xlabel("Neural timescale " + r'$\mathrm{s}$')
